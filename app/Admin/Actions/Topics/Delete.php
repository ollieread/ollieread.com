...
class Delete extends Action
{
    public function delete(int $id)
    {
        ...
        if ($topic) {
            return $this->response()->view('admin.topics.delete', compact('topic'));
        }
    ...
    public function destroy(int $id, Request $request)
    {
        ...
        if ($topic) {
            ...
            if ((new DeleteTopic)->setInput($input)->setTopic($topic)->perform()) {
                Alerts::success(trans('admin.delete.success', ['entity' => trans_choice('entities.topic', 1)]), 'admin.topics');
            ...
            return $this->response()->redirectToRoute('admin:topic.delete', $topic->id);
        }
