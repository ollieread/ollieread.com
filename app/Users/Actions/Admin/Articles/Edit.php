...
class Edit extends Action
{
    public function edit(int $id)
    {
        ...
        if ($article) {
            ...
            return $this->response()->view('users.admin.articles.edit', compact('article', 'versions', 'topics', 'articleVersions', 'articleTopics'));
        }
    ...
    public function update(int $id, Request $request)
    {
        ...
        if ($article) {
            ...
            if ((new UpdateArticle)->setArticle($article)->setInput($input)->perform()) {
                Alerts::success(trans('users.admin.edit.success', ['entity' => trans_choice('entities.article', 1)]), 'admin.articles');
