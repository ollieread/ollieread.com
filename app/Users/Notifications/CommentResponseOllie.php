...
class CommentResponseOllie extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->line(sprintf('There has been a response to your article %s by %s.', $this->comment->article->name, $this->comment->author->username))
