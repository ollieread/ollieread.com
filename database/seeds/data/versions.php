...
return [
    ...
    /*[
        ...
        'description'  => null,
        'docs'         => null,
        'release_date' => Carbon\Carbon::createFromDate(1988, 6, 24),
    ],*/
    ...
    [
        ...
        'release_date' => Carbon\Carbon::createFromDate(2016, 12, 1),
    ],
    ...
    [
        ...
        'description'  => 'PHP: Hypertext Preprocessor (or simply PHP) is a general-purpose programming language originally designed for web development.',
        'docs'         => 'https://www.php.net/manual',
        'release_date' => Carbon\Carbon::createFromDate(2017, 11, 30),
    ],
    ...
    [
        ...
        'description'  => 'PHP: Hypertext Preprocessor (or simply PHP) is a general-purpose programming language originally designed for web development.',
        'docs'         => 'https://www.php.net/manual',
        'release_date' => Carbon\Carbon::createFromDate(2018, 12, 6),
    ],
